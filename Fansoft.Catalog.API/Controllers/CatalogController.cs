...
namespace Fansoft.Catalog.API.Controllers
{
    ...
    public class CatalogController : ControllerBase
    {
        ...
        [HttpGet]
        public ActionResult<IEnumerable<CatalogItemVM>> GetItens()
        {
            ...
            var result = _items.Select(item => new CatalogItemVM
            {
                Id = item.Id,
                Name = item.Name,
                Description = item.Description,
        ...
        [HttpPut("{id}")]
        public IActionResult Update(int id,[FromBody]CatalogItemForCreationVM model)
        {
        ...
        public IActionResult Delete(int id)
        {
            ...
            if(item is null){
                ModelState.AddModelError("id", "Catalog not found");
                return ValidationProblem();
            }
